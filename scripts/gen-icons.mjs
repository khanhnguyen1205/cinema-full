...
// Dựng icon PWA "C" đỏ Bebas trên nền gần-đen bằng headless Chrome.
...
function html({ size, letterScale, border }) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .c{font-family:'Bebas Neue',sans-serif;color:#e63030;font-size:${fontSize}px;line-height:1;position:relative;}
