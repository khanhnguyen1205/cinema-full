  ...
  return (
    <div className="pay-step">
      <div className="pay-head">
        ...
        <p className="pay-sub">Đây là bản demo — không nhập và không lưu thông tin thẻ thật.</p>
      </div>

      <div className="pay-methods">
        {METHODS.map((m) => (
          <label key={m.key} className={`pay-card ${method === m.key ? "picked" : ""}`}>
            <input
              type="radio"
              name="payment"
              value={m.key}
            ...
            />
            <span className="pay-emoji" aria-hidden="true">{m.emoji}</span>
      ...
      <p className="pay-note">🔒 Thông tin đơn hàng được mã hoá. Nhấn “Thanh toán” để hoàn tất và nhận vé điện tử.</p>
    </div>
  );
}
