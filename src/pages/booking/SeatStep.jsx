        ...
        <div className="seat-map-inner" style={{ transform: `scale(${zoom})` }}>
                    ...
                    {seats.map((seat) => {
                      ...
                      return (
                        <span
                          ...
                          className="seat-slot"
                          style={{
                            marginRight: aisles.includes(seat.col)
                              ? 22
                              : undefined,
                          }}
                        >
                          ...
                          >
                            ...
                            <span className="seat-tip">
                              {seat.seatNumber} · {SEAT_TYPE[type].label} ·{" "}
          ...
          <div className="seat-legend">
            <div className="legend-item">
              <span className="legend-dot lg-standard" />
              Thường {fmt(base)}
            </div>
            <div className="legend-item">
              <span className="legend-dot lg-vip" />
              VIP
            </div>
            <div className="legend-item">
              <span className="legend-dot lg-couple" />
              Đôi
            </div>
            <div className="legend-item">
              <span className="legend-dot lg-selected" />
              Đang chọn
            </div>
            <div className="legend-item">
              <span className="legend-dot lg-booked" />
              Đã đặt
            </div>
          </div>
        </div>
